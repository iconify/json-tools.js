...
(() => {
    ...
    describe('Getting JSON data', () => {
        it('getIcons()', () => {
            ...
            expect(Object.keys(items.icons)).to.be.eql(['arrow-circle-left', 'arrow-circle-up', 'arrow-up', 'arrow-left', 'arrows', 'arrows-alt', 'arrows-h', 'arrows-v', 'assistive-listening-systems', 'asterisk', 'at', 'audio-description']);
            expect(Object.keys(items.aliases)).to.be.eql(['arrow-circle-right', 'arrow-down', 'arrow-right']);
            ...
            // Same, but using optimized JSON. Result should have all default values
