...
(() => {
    ...
    describe('JSON optimization', () => {
        it('optimizing FontAwesome JSON', () => {
            ...
            expect(optimized.icons['audio-description'].verticalAlign).to.be.equal(void 0);
            ...
            Object.keys(optimized.icons).forEach(key => {
                expect(optimized.icons[key].height === void 0 || optimized.icons[key].height !== 1536).to.be.equal(true);
            });
