...
(() => {
    ...
    describe('Removing icons, listing icons, checking if icon exists', () => {
        it('collection with aliases', () => {
            ...
            expect(icons).to.be.eql(['arrow-circle-left', 'arrow-circle-up', 'arrow-up', 'arrow-left', 'arrows', 'arrows-alt', 'arrows-h', 'arrows-v', 'assistive-listening-systems', 'asterisk', 'at', 'audio-description']);

            // Check original icons list with aliases
            icons = collection.listIcons(true);
            expect(icons).to.be.eql(['arrow-circle-left', 'arrow-circle-up', 'arrow-up', 'arrow-left', 'arrows', 'arrows-alt', 'arrows-h', 'arrows-v', 'assistive-listening-systems', 'asterisk', 'at', 'audio-description', 'arrow-circle-right', 'arrow-down', 'arrow-right']);
            ...
            expect(icons).to.be.eql(['arrow-circle-left', 'arrow-circle-up', 'arrow-up', 'arrow-left', 'arrows-alt', 'arrows-h', 'arrows-v', 'assistive-listening-systems', 'asterisk', 'at', 'audio-description']);
            ...
            icons = collection.listIcons(true);
            expect(icons).to.be.eql(['arrow-circle-left', 'arrow-circle-up', 'arrow-left', 'arrows-alt', 'arrows-h', 'arrows-v', 'assistive-listening-systems', 'asterisk', 'at', 'audio-description', 'arrow-circle-right', 'arrow-down', 'arrow-right']);
            ...
            icons = collection.listIcons(true);
            expect(icons).to.be.eql(['arrow-circle-left', 'arrow-circle-up', 'arrows-alt', 'arrows-h', 'arrows-v', 'assistive-listening-systems', 'asterisk', 'at', 'audio-description', 'arrow-circle-right', 'arrow-down']);
        ...
        it('collection without aliases', () => {
            ...
            icons = collection.listIcons(true);
            expect(icons).to.be.eql(['arrow-circle-left', 'arrow-circle-up', 'arrow-up', 'arrow-left', 'arrows', 'arrows-alt', 'arrows-h', 'arrows-v', 'assistive-listening-systems', 'asterisk', 'audio-description']);
